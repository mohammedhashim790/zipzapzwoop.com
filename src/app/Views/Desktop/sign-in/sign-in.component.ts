...
import {OkayCancelComponent, OkayCancelDialogParams} from "../../DialogViews/okay-cancel/okay-cancel.component";
import {printer} from "../../../app.component";
import {FormBuilder, FormControl, FormGroup, Validators} from "@angular/forms";
import {Auth} from "aws-amplify";
import {cognitoAUTH, confirmSignUpException} from "../../../Bloc/Signer/Constants";
import {SignIn, SignInWithGoogle, SignOut} from 'src/app/Bloc/Signer/SignInHelper';
  ...
  ValidateSignIn() {
    ...
    SignIn(this.signInForm.value).then((res)=>{
      ...
      if(res['challengeName'])
        ...
        this.router.navigateByUrl('').then((res)=>window.location.reload());
